...
//ULTIMA ATUALIZAÇÃO DIA 18/12/2021 - ADICIONADO EDURAM E RESOLUÇÃO DE BUGS
...

{
    ...
    Serial.println("Porta: " + String(dadosConfig.httpPort));
    Serial.println("tempo: " + String(dadosConfig.tempo));
    Serial.println("###############################");
    ...
    if (tara2 != -1)
    {
        inicializarBalanca(&balanca1, escala2, tara2, DT1, SCK);
    };
    if (tara3 != -1)
    {
        inicializarBalanca(&balanca2, escala3, tara3, DT2, SCK);
    };
   ...
   // Serial.println(Cliente(dadosConfig.httpPort, tochar(dadosConfig.host), "/"));
}
#pragma endregion
#pragma region //LOOP #####################################
void loop()
...
#pragma region //WIFI - VISUAL
                    else if (req.rota == "wifi")
                    {
                        ...
                        client.println("<input type='text' name='email' placeholder='EMAIl (deixar vazio caso não tenha)'><br><br>");
...
bool lisimetro(double massa, int balan)
{
    ...
    case 1:
        ...
        Serial.println("resposta:" + Cliente(dadosConfig.httpPort, tochar(dadosConfig.host), String("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara1) + "&escala=" + String(escala1) + "&nome=" + periodo1)));
        Serial.println("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara1) + "&escala=" + String(escala1) + "&nome=" + periodo1);
        break;
    case 2:
        Serial.println("resposta:" + Cliente(dadosConfig.httpPort, tochar(dadosConfig.host), String("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara2) + "&escala=" + String(escala2) + "&nome=" + periodo2)));
        Serial.println("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara2) + "&escala=" + String(escala2) + "&nome=" + periodo2);
        break;
    case 3:
        Serial.println("resposta:" + Cliente(dadosConfig.httpPort, tochar(dadosConfig.host), String("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara3) + "&escala=" + String(escala3) + "&nome=" + periodo3)));
        Serial.println("/gravar.php?balanca=" + String(balan) + "&massa=" + String(massa) + "&tara=" + String(tara3) + "&escala=" + String(escala3) + "&nome=" + periodo3);
        break;
    }
    return true;
}
